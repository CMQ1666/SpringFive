...
public interface RepayDao {
     ...
     * @return
     */
    @Select("<script>select r.REPAYED_ALL_MONEY,r.GRZH,r.ALL_MONEY,r.PNAME,r.LOAN_MONEY,r.LOAN_PERIODS,r.LOAN_RATE,r.RESIDUE_MONEY,\n" +
            "            r.REPAYED_PERIODS,r.RESIDUE_PERIODS,r.RESIDUE_MONEY ,r.REPAY_MONTH,r.REPAY_MONEY,REPAY_INTERESTS from \n" +
     ...
     * @return
     */
    @Insert("insert into tb_repay_record (record_id,grzh,pname,repayed_date,REPAYED_PERIODS,REPAY_MONTH )" +
            "values(SEQ_RECORD.nextval,#{GRZH},#{PNAME},to_date(sysdate)," +
            "#{REPAYED_PERIODS}，#{REPAY_MONTH})")
