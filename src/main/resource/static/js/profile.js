...
$(function(){
    ...
    $("#profile_info_submit").click(function(){
        if ($("#info_idcard").length > 0 && !confirm("璇峰啀娆＄‘璁ゆ偍鎵�～鍐欑殑淇℃伅鏄惁姝ｇ‘锛屽鏋滀笉姝ｇ‘璇风偣\"鍙栨秷\"骞朵慨鏀�)) return false;
    ...
    $("#profile_job_submit").click(function(){
        if ($("#job_company").length > 0 && !confirm("璇峰啀娆＄‘璁ゆ偍鎵�～鍐欑殑淇℃伅鏄惁姝ｇ‘锛屽鏋滀笉姝ｇ‘璇风偣\"鍙栨秷\"骞朵慨鏀�)) return false;
    ...
    $("#profile_contact_submit").click(function(){
        if ($("#contact_family_name").length > 0 && !confirm("璇峰啀娆＄‘璁ゆ偍鎵�～鍐欑殑淇℃伅鏄惁姝ｇ‘锛屽鏋滀笉姝ｇ‘璇风偣\"鍙栨秷\"骞朵慨鏀�)) return false;
